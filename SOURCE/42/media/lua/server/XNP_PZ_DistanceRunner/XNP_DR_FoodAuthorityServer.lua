...
local function onClientCommandAdapter(module, command, player, args)
    return Server.OnClientCommand(module, command, player, args)
end
...
function Server.Register()
    ...
    if Events and Events.OnClientCommand and type(Events.OnClientCommand.Add) == "function" then
        Events.OnClientCommand.Add(onClientCommandAdapter)
    end

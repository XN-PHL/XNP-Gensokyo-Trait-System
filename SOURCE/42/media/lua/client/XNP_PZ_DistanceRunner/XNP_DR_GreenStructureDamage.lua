...
local function onWeaponHitThumpableAdapter(attacker, weapon, target)
    return Structure.OnWeaponHitThumpable(attacker, weapon, target)
end
...
function Structure.Register()
    ...
    Events.OnWeaponHitThumpable.Add(onWeaponHitThumpableAdapter)
